    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?=site_url('student/list')?>">
              <i class="fa fa-user-circle menu-icon"></i>
              <span class="menu-title">Student</span>
            </a>
          </li>
           <li class="nav-item">
            <a class="nav-link" href="<?=site_url('staff/list')?>">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link" href="<?=site_url('class/list')?>">
              <i class="fa fa-user-plus menu-icon"></i>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="page-layouts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="<?=site_url('category/add')?>">Add category</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?=site_url('category/view_category')?>">View category</a></li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">Online Class</span>
              <i class="menu-arrow"></i>
            </a>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-advanced" aria-expanded="false" aria-controls="ui-advanced">
              ...
              <span class="menu-title">Zoom live class</span>
              <i class="menu-arrow"></i>
            </a>
